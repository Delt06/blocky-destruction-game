...
public sealed class BlockTerrainMeshBuilder
{
	...
	public BlockTerrainMeshBuilder(Mesh mesh, float bordersInPixels)
	{
		_mesh = mesh;
	...
	private static readonly Dictionary<WorldSide, Vector3[]> WorldSideVertices = new Dictionary<WorldSide, Vector3[]>
	{
